...
func (_m *CustomerRepository) CreateCustomer(customer *entity.DetailCustomer) error {
...
func (_m *CustomerRepository) GetCustomerByID(NIK string) (*entity.DetailCustomer, error) {
	ret := _m.Called(NIK)
